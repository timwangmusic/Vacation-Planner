...
type PlaceSearchRequest struct {
	...
	// "city,country" or "lat,lng"
	Location string
	// search radius
	Radius uint
	// minimum number of results, set this lower limit for reducing risk of zero result in upper-layer computations.
	// suppose a location has more places establised over time, this field would help trigger new searchs to get those new establishments.
	MinNumResults uint
}
