...
const { test, expect, describe, beforeEach, afterEach, beforeAll, afterAll } = require("@jest/globals");
...
describe('Test findCenter of array of latLng points', () => {
    ...
    test('Successfully find center', () => {
        ...
        spy.mockReturnValue(0).mockReturnValueOnce(latCenter).mockReturnValue(lngCenter);
